...
#            return self.opt_dict[option]
        if isinstance(self.opt_dict[option], str):
            if self.opt_dict[option] == 'YES' or self.opt_dict[option] == 'yes' or self.opt_dict[option] == 'Yes':
                self.opt_dict[option] = True
            elif self.opt_dict[option] == 'NO' or self.opt_dict[option] == 'No' or self.opt_dict[option] == 'no':
                self.opt_dict[option] = False
